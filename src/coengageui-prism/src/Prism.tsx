...
export const Prism: PrismComponent = forwardRef<HTMLDivElement, PrismProps>(
  (props: PrismProps, ref) => {
    const {
      ...
      trim,
      ...others
    } = useCoengageUIDefaultProps('Prism', prismDefaultProps, props);
...
export const PrismTabs = forwardRef<HTMLDivElement, PrismTabsProps>(
  (props: PrismTabsProps, ref) => {
    const { children, classNames, styles, ...others } = useCoengageUIDefaultProps(
      'PrismTabs',
      {},
      props
    );
...
Prism.Tab = PrismTab;
Prism.displayName = 'coengageui_prism/Prism';
PrismTabs.displayName = 'coengageui_prism/Tabs';
PrismTab.displayName = 'coengageui_prism/Tab';
