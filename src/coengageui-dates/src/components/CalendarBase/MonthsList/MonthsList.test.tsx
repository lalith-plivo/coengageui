...
describe('@coengageui/dates/MonthsList', () => {
  ...
  it('calls onNextLevel when level label is clicked', () => {
    ...
    userEvent.click(container.querySelector('.coengageui-MonthsList-calendarHeaderLevel'));
  ...
  it('renders correct amount of months', () => {
    ...
    expect(two.querySelectorAll('.coengageui-MonthsList-month')).toHaveLength(2);
    expect(three.querySelectorAll('.coengageui-MonthsList-month')).toHaveLength(3);
    expect(four.querySelectorAll('.coengageui-MonthsList-month')).toHaveLength(4);
  });
