...
const CONTROL_SELECTOR = '.coengageui-MonthPicker-monthPickerControl';
const ACTIVE_CONTROL_SELECTOR = '.coengageui-MonthPicker-monthPickerControlActive';
const LEVEL_SELECTOR = '.coengageui-MonthPicker-calendarHeaderLevel';
const HEADER_CONTROL_SELECTOR = '.coengageui-MonthPicker-calendarHeaderControl';
