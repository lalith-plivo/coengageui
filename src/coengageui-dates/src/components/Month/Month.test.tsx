...
describe('coengageui_dates/Month', () => {
  ...
  it('renders correct amount of weekdays', () => {
    ...
    expect(container.querySelectorAll('.coengageui-Month-weekdayCell')).toHaveLength(7);
  });
  ...
  it('adds styles when month days are within range', () => {
    ...
    expect(withRange.querySelectorAll('.coengageui-Month-firstInRange')).toHaveLength(1);
    expect(withRange.querySelectorAll('.coengageui-Month-lastInRange')).toHaveLength(1);
    expect(withRange.querySelectorAll('.coengageui-Month-inRange')).toHaveLength(11);

    expect(withoutRange.querySelectorAll('.coengageui-Month-firstInRange')).toHaveLength(0);
    expect(withoutRange.querySelectorAll('.coengageui-Month-lastInRange')).toHaveLength(0);
    expect(withoutRange.querySelectorAll('.coengageui-Month-inRange')).toHaveLength(0);
  });
  ...
  it('does not add styles when month days outside of range', () => {
    ...
    expect(container.querySelectorAll('.coengageui-Month-firstInRange')).toHaveLength(0);
    expect(container.querySelectorAll('.coengageui-Month-lastInRange')).toHaveLength(0);
    expect(container.querySelectorAll('.coengageui-Month-inRange')).toHaveLength(0);
  });
  ...
  it('adds partial range styles', () => {
    ...
    expect(container.querySelectorAll('.coengageui-Month-firstInRange')).toHaveLength(1);
    expect(container.querySelectorAll('.coengageui-Month-lastInRange')).toHaveLength(0);
    expect(container.querySelectorAll('.coengageui-Month-inRange')).toHaveLength(9);
  });
  ...
  it('displays selected date', () => {
    ...
    expect(days[6]).toHaveClass('coengageui-Month-selected');
    expect(days[7]).not.toHaveClass('coengageui-Month-selected');
    expect(days[5]).not.toHaveClass('coengageui-Month-selected');
  });
  ...
  it('changes first day of week based on prop', () => {
    ...
    expect(sunday.querySelectorAll('.coengageui-Month-weekdayCell')[0].textContent).toBe('Su');
    expect(sunday.querySelectorAll('.coengageui-Month-weekdayCell')[6].textContent).toBe('Sa');

    expect(monday.querySelectorAll('.coengageui-Month-weekdayCell')[0].textContent).toBe('Mo');
    expect(monday.querySelectorAll('.coengageui-Month-weekdayCell')[6].textContent).toBe('Su');
  });
