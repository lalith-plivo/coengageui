...
describe('coengageui_dropzone/Dropzone', () => {
  ...
  it('displays LoadingOverlay based on loading prop', () => {
    ...
    expect(loading.querySelectorAll('.coengageui-LoadingOverlay-root')).toHaveLength(1);
    expect(notLoading.querySelectorAll('.coengageui-LoadingOverlay-root')).toHaveLength(0);
  });
