...
export const SPOTLIGHT_EVENTS = {
  open: 'coengage:open-spotlight',
  close: 'coengage:close-spotlight',
  toggle: 'coengage:toggle-spotlight',
  triggerAction: 'coengage:trigger-spotlight-action',
  registerActions: 'coengage:register-spotlight-actions',
  removeActions: 'coengage:remove-spotlight-actions',
} as const;
