...
export const NOTIFICATIONS_EVENTS = {
  show: 'coengage:show-notification',
  hide: 'coengage:hide-notification',
  update: 'coengage:update-notification',
  clean: 'coengage:clean-notifications',
  cleanQueue: 'coengage:clean-notifications-queue',
} as const;
