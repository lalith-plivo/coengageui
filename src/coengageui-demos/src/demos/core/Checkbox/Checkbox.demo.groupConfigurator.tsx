...
import { CheckboxGroup, CheckboxGroupProps, Checkbox } from '@coengageui/core';

const codeTemplate = (props: string) => `
import { CheckboxGroup, Checkbox } from '@coengageui/core';
...
export const groupConfigurator: CoengageUIDemo = {
  type: 'configurator',
  component: Wrapper,
  codeTemplate,
