...
describe('@coengageui/core/AvatarsGroup', () => {
  ...
  it('renders avatars based on limit prop', () => {
    ...
    expect(limit2.querySelectorAll('.coengageui-Avatar-root')).toHaveLength(3);
    expect(limit3.querySelectorAll('.coengageui-Avatar-root')).toHaveLength(4);
    expect(limit10.querySelectorAll('.coengageui-Avatar-root')).toHaveLength(4);
  });
