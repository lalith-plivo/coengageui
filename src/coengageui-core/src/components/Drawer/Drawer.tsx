...
const transitions: Record<DrawerPosition, CoengageUITransition> = {
  top: 'slide-down',
  bottom: 'slide-up',
  left: 'slide-right',
  right: 'slide-left',
...
const rtlTransitions: Record<DrawerPosition, CoengageUITransition> = {
  top: 'slide-down',
  bottom: 'slide-up',
  right: 'slide-right',
  left: 'slide-left',
...
export function Drawer(props: DrawerProps) {
  const {
    ...
    overlayBlur,
    ...others
  } = useCoengageUIDefaultProps('Drawer', defaultProps, props);
          ...
          >
            <Paper<'div'>
              ...
              onKeyDownCapture={(event) => {
                const shouldTrigger =
                  (event.target as any)?.getAttribute('data-coengageui-stop-propagation') !== 'true';
