...
describe('coengageui_core/Image', () => {
  checkAccessibility([
    <Image {...defaultProps} />,
  ...
  itSupportsSystemProps({
    component: Image,
    props: defaultProps,
    displayName: 'coengageui_core/Image',
  ...
  it('renders placeholder based on withPlaceholder prop', () => {
    ...
    expect(withPlaceholder.querySelectorAll('.coengageui-Image-placeholder')).toHaveLength(1);
    expect(withoutPlaceholder.querySelectorAll('.coengageui-Image-placeholder')).toHaveLength(0);
  });
