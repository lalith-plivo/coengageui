...
const getRightSection = (container: HTMLElement) =>
  container.querySelector('.coengageui-NumberInput-rightSection');

const clickIncrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.coengageui-NumberInput-controlUp'));

const clickDecrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.coengageui-NumberInput-controlDown'));
