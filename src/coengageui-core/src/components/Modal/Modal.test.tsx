...
describe('@coengageui/core/Modal', () => {
  ...
  it('allows to hide close button', () => {
    ...
    expect(withButton.querySelectorAll('.coengageui-Modal-close')).toHaveLength(1);
    expect(withoutButton.querySelectorAll('.coengageui-Modal-close')).toHaveLength(0);
  });
  ...
  it('does not render modal header if close button is hidden and title is not passed', () => {
    ...
    expect(withHeader.querySelectorAll('.coengageui-Modal-header')).toHaveLength(1);
    expect(withoutHeader.querySelectorAll('.coengageui-Modal-header')).toHaveLength(0);
  });
