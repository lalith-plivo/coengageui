...
describe('coengageui_core/PopoverBody', () => {
  ...
  it('renders close button based on withCloseButton prop', () => {
    ...
    expect(withCloseButton.querySelectorAll('.coengageui-Popover-close')).toHaveLength(1);
    expect(withoutCloseButton.querySelectorAll('.coengageui-Popover-close')).toHaveLength(0);
  });
