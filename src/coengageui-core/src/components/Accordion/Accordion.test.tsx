...
describe('@coengageui/core/Accordion', () => {
  ...
  it('renders correct amount of items', () => {
    ...
    expect(container.querySelectorAll('.coengageui-Accordion-item')).toHaveLength(3);
  });
  ...
  it('filters out unexpected children', () => {
    ...
    expect(container.querySelectorAll('.coengageui-Accordion-item')).toHaveLength(2);
    expect(container.querySelectorAll('.coengageui-Button-root')).toHaveLength(0);
