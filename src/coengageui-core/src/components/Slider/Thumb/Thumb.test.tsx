...
describe('coengageui_core/Thumb', () => {
  ...
  it('shows label based on dragging and labelAlwaysOn props', () => {
    ...
    expect(labelAlwaysOn.querySelectorAll('.coengageui-Slider-label')).toHaveLength(1);
    expect(dragging.querySelectorAll('.coengageui-Slider-label')).toHaveLength(1);
    expect(labelOff.querySelectorAll('.coengageui-Slider-label')).toHaveLength(0);
  });
