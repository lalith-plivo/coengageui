...
const queries = {
  getLabel: (container: HTMLElement) => container.querySelector('.coengageui-InputWrapper-label'),
  getError: (container: HTMLElement) => container.querySelector('.coengageui-InputWrapper-error'),
  getRequired: (container: HTMLElement) =>
    container.querySelector('.coengageui-InputWrapper-required'),
