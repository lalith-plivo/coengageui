...
describe('coengageui_core/Tooltip', () => {
  ...
  it('sets body width based on prop', async () => {
    ...
    expect(container.querySelector('.coengageui-Tooltip-body')).toHaveStyle({ width: '164px' });
  });
  ...
  it('sets body white-space style based on wrapLines prop', async () => {
    ...
    expect(wrap.querySelector('.coengageui-Tooltip-body')).toHaveStyle({ whiteSpace: 'normal' });
    expect(noWrap.querySelector('.coengageui-Tooltip-body')).toHaveStyle({ whiteSpace: 'nowrap' });
  });
});
