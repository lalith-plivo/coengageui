...
slug: /core/button/
category: 'inputs'
description: 'Render button or link with button styles from coengage theme'
props: ['Button']
import: "import { Button } from 'coengageui_core';"
source: 'coengageui-core/src/components/Button/Button.tsx'
docs: 'core/Button.mdx'
styles: ['Button']
---

import { ButtonDemos } from 'coengageui_demos';
...
it renders regular button without default browser styles and with CoengageUI focus styles:
