...
props: ['RingProgress']
import: "import { RingProgress } from 'coengageui_core';"
source: 'coengageui-core/src/components/RingProgress/RingProgress.tsx'
docs: 'core/RingProgress.mdx'
styles: ['RingProgress']
---

import { RingProgressDemos } from 'coengageui_demos';
