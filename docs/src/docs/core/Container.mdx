...
props: ['Container']
import: "import { Container } from 'coengageui_core';"
source: 'coengageui-core/src/components/Container/Container.tsx'
docs: 'core/Container.mdx'
styles: ['Container', 'single-node']
---

import { ContainerDemos } from 'coengageui_demos';
...
To configure container sizes use default props on [CoengageUIProvider](/theming/coengageui-provider/):

```tsx
import { CoengageUIProvider, Container } from 'coengageui_core';
