...
props: ['ColorInput']
import: "import { ColorInput } from 'coengageui_core';"
source: 'coengageui-core/src/components/ColorInput/ColorInput.tsx'
docs: 'core/ColorInput.mdx'
styles: ['ColorInput']
---

import { ColorInputDemos, ColorPickerDemos } from 'coengageui_demos';
