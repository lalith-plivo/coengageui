...
props: ['Grid']
import: "import { Grid } from '@coengageui/core';"
source: 'coengageui-core/src/components/Grid/Grid.tsx'
docs: 'core/Grid.mdx'
styles: ['Grid', 'single-node']
---

import { GridDemos } from '@coengageui/demos';
...
You can configure breakpoint values in [CoengageUIProvider](/theming/extend-theme/#breakpoints).
