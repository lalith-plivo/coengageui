...
props: ['Autocomplete']
import: "import { Autocomplete } from 'coengageui_core';"
source: 'coengageui-core/src/components/Autocomplete/Autocomplete.tsx'
docs: 'core/Autocomplete.mdx'
styles: ['Autocomplete']
---

import { AutocompleteDemos } from 'coengageui_demos';
