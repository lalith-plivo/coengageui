...
props: ['NativeSelect']
import: "import { NativeSelect } from 'coengageui_core';"
source: 'coengageui-core/src/components/NativeSelect/NativeSelect.tsx'
docs: 'core/NativeSelect.mdx'
styles: ['NativeSelect']
---

import { NativeSelectDemos } from 'coengageui_demos';
