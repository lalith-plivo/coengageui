...
props: ['Pagination']
import: "import { Pagination } from 'coengageui_core';"
source: 'coengageui-core/src/components/Pagination/Pagination.tsx'
docs: 'core/Pagination.mdx'
styles: ['Pagination']
---

import { PaginationDemos } from 'coengageui_demos';
...
If you need more flexibility coengageui_hooks exports [use-pagination](/hooks/use-pagination/) hook,
