...
props: ['ColorSwatch']
import: "import { ColorSwatch } from 'coengageui_core';"
source: 'coengageui-core/src/components/ColorSwatch/ColorSwatch.tsx'
docs: 'core/ColorSwatch.mdx'
styles: ['ColorSwatch', 'single-node']
---

import { ColorSwatchDemos } from 'coengageui_demos';
