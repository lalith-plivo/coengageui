...
import: "import { AppShell, Navbar, Header, Aside, Footer } from 'coengageui_core';"
source: 'coengageui-core/src/components/AppShell/AppShell.tsx'
...
import { AppShellDemos } from 'coengageui_demos';

## Usage

AppShell is a layout component that can be used to create a common Header - Navbar - Footer - Aside - Content layout pattern.
AppShell, Header, Footer, Aside and Navbar components include bare minimum default styles to simplify customization. [View full source code](https://github.com/coengagedev/coengage/tree/master/src/coengageui-demos/src/demos/core/AppShell)
...
Navbar and Aside components can be used outside of AppShell context ([View full source code](https://github.com/coengagedev/coengage/tree/master/src/coengageui-demos/src/demos/core/AppShell)):
...
To make Navbar or Aside fixed (like in CoengageUI docs) set `fixed` and `position` props:
...
`Navbar.Section` and `Aside.Section` components can be used with [ScrollArea](/core/scroll-area/) component ([View full source code](https://github.com/coengagedev/coengage/tree/master/src/coengageui-demos/src/demos/core/AppShell)):
