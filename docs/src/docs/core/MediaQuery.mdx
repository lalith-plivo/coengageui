...
props: ['MediaQuery']
import: "import { MediaQuery } from 'coengageui_core';"
source: 'coengageui-core/src/components/MediaQuery/MediaQuery.tsx'
docs: 'core/MediaQuery.mdx'
styles: ['MediaQuery', 'single-node']
---

import { DEFAULT_THEME } from 'coengageui_core';
import { MediaQueryDemos } from 'coengageui_demos';
...
To change these values wrap your application with CoengageUIProvider and set `breakpoints` prop on theme:
...
import { MediaQuery } from 'coengageui_core';
