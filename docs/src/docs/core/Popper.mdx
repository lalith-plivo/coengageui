...
props: ['Popper']
import: "import { Popper } from '@coengageui/core';"
source: 'coengageui-core/src/components/Popper/Popper.tsx'
docs: 'core/Popper.mdx'
---

import { PopperDemos, TooltipDemos } from '@coengageui/demos';

## Usage

Popper is a utility component used under the hood in [Menu](/core/menu/), [Popover](/core/popover/), [Tooltip](/core/tooltip/)
and other CoengageUI components. You can use it to create your own dropdowns and popovers if CoengageUI components do not meet your requirements.
...
import { Popper } from '@coengageui/core';
