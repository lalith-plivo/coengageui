...
props: ['Transition']
import: "import { Transition, GroupedTransition } from '@coengageui/core';"
source: 'coengageui-core/src/components/Transition/Transition.tsx'
docs: 'core/Transition.mdx'
---

import { TooltipDemos, TransitionDemos } from '@coengageui/demos';
...
CoengageUI includes several premade transitions:
...
```tsx
import { Transition } from '@coengageui/core';
...
```tsx
import { GroupedTransition } from '@coengageui/core';
