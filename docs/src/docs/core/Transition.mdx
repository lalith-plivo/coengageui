...
props: ['Transition']
import: "import { Transition, GroupedTransition } from 'coengageui_core';"
source: 'coengageui-core/src/components/Transition/Transition.tsx'
docs: 'core/Transition.mdx'
---

import { TooltipDemos, TransitionDemos } from 'coengageui_demos';
...
```tsx
import { Transition } from 'coengageui_core';
...
```tsx
import { GroupedTransition } from 'coengageui_core';
