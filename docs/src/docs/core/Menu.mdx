...
props: ['Menu']
import: "import { Menu } from '@coengageui/core';"
source: 'coengageui-core/src/components/Menu/Menu.tsx'
docs: 'core/Menu.mdx'
styles: ['Menu']
---

import { MenuDemos } from '@coengageui/demos';
...
```tsx
import { Menu, Text } from '@coengageui/core';
...
<Menu.Item component="a" href="https://coengage/dev" target="_blank" />
...
```tsx
import { Menu } from '@coengageui/core';
import { NextLink } from '@coengageui/next';
