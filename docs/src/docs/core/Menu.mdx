...
props: ['Menu']
import: "import { Menu } from 'coengageui_core';"
source: 'coengageui-core/src/components/Menu/Menu.tsx'
docs: 'core/Menu.mdx'
styles: ['Menu']
---

import { MenuDemos } from 'coengageui_demos';
...
```tsx
import { Menu, Text } from 'coengageui_core';
...
```tsx
import { Menu } from 'coengageui_core';
import { NextLink } from 'coengageui_next';
