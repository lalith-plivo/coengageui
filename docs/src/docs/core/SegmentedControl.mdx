...
import: "import { SegmentedControl } from 'coengageui_core';"
source: 'coengageui-core/src/components/SegmentedControl/SegmentedControl.tsx'
docs: 'core/SegmentedControl.mdx'
styles: ['SegmentedControl']
---

import { SegmentedControlDemos } from 'coengageui_demos';
