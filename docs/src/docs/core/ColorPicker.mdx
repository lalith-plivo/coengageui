...
props: ['ColorPicker']
import: "import { ColorPicker } from 'coengageui_core';"
source: 'coengageui-core/src/components/ColorPicker/ColorPicker.tsx'
docs: 'core/ColorPicker.mdx'
styles: ['ColorPicker']
---

import { ColorPickerDemos } from 'coengageui_demos';
