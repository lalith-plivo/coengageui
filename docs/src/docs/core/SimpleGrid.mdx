...
props: ['SimpleGrid']
import: "import { SimpleGrid } from '@coengageui/core';"
source: 'coengageui-core/src/components/SimpleGrid/SimpleGrid.tsx'
docs: 'core/SimpleGrid.mdx'
styles: ['SimpleGrid', 'single-node']
---

import { SimpleGridDemos } from '@coengageui/demos';
