...
import: "import { LoadingOverlay } from 'coengageui_core';"
source: 'coengageui-core/src/components/LoadingOverlay/LoadingOverlay.tsx'
docs: 'core/LoadingOverlay.mdx'
styles: ['LoadingOverlay', 'single-node']
---

import { LoadingOverlayDemos } from 'coengageui_demos';
...
```tsx
import { LoadingOverlay } from 'coengageui_core';
