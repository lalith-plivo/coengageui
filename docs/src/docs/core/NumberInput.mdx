...
props: ['NumberInput']
import: "import { NumberInput } from 'coengageui_core';"
source: 'coengageui-core/src/components/NumberInput/NumberInput.tsx'
docs: 'core/NumberInput.mdx'
styles: ['NumberInput']
---

import { NumberInputDemos } from 'coengageui_demos';
