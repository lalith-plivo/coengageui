...
props: ['Stepper', 'Step']
import: "import { Stepper, Step } from 'coengageui_core';"
source: 'coengageui-core/src/components/Stepper/Stepper.tsx'
docs: 'core/Stepper.mdx'
styles: ['Stepper']
---

import { StepperDemos } from 'coengageui_demos';
...
You can [configure breakpoints](/theming/extend-theme/#breakpoints) in CoengageUIProvider or use
...
Loader will replace step icon. You can configure default loader in [CoengageUIProvider](/theming/coengageui-provider/).
