...
props: ['ScrollArea']
styles: ['ScrollArea']
import: "import { ScrollArea } from '@coengageui/core';"
source: 'coengageui-core/src/components/ScrollArea/ScrollArea.tsx'
docs: 'core/ScrollArea.mdx'
---

import { AppShellDemos, ScrollAreaDemos } from '@coengageui/demos';
...
ScrollArea integrates seamlessly with all CoengageUI components that can require scrollbars.
