...
source: 'coengageui-notifications/src'
docs: 'others/notifications.mdx'
pageTitle: 'CoengageUI Notifications'
description: 'CoengageUI notifications system'
installation: '@coengageui/notifications'
license: MIT
---

import { NotificationDemos, NotificationsDemos } from '@coengageui/demos';
...
```sh
npm install @coengageui/notifications @coengageui/core @coengageui/hooks
```

Install with yarn:

```sh
yarn add @coengageui/notifications @coengageui/core @coengageui/hooks
```
...
`@coengageui/notifications` package exports the following functions:
...
All functions can be imported from `@coengageui/notifications` package and can be used in any part of your application:
...
```tsx
import { showNotification, hideNotification } from '@coengageui/notifications';
