...
import: "import { Dropzone, FullScreenDropzone } from '@coengageui/dropzone';"
source: 'coengageui-dropzone/src'
docs: 'others/dropzone.mdx'
installation: '@coengageui/dropzone'
license: MIT
...
} from '@coengageui/dropzone';
import { DropzoneDemos } from '@coengageui/demos';
...
To save some research time you can use `MIME_TYPES` variable exported from `@coengageui/dropzone`:

```tsx
import { Dropzone, MIME_TYPES } from '@coengageui/dropzone';
...
```tsx
import { IMAGE_MIME_TYPE, Dropzone } from '@coengageui/dropzone';
