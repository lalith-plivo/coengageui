...
import: "import { ModalsProvider } from 'coengageui_modals';"
source: 'coengageui-modals/src'
docs: 'others/modals.mdx'
installation: 'coengageui_modals'
license: MIT
---

import { ModalsDemos } from 'coengageui_demos';
...
```sh
npm install coengageui_modals coengageui_core coengageui_hooks
```

Install with yarn:

```sh
yarn add coengageui_modals coengageui_core coengageui_hooks
```
...
import { ModalsProvider } from 'coengageui_modals';
...
coengageui_modals package includes special modal that can be used for confirmations.
...
```tsx
import { ContextModalProps, ModalsProvider } from 'coengageui_modals';
