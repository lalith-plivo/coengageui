...
import: "import { ModalsProvider } from '@coengageui/modals';"
source: 'coengageui-modals/src'
docs: 'others/modals.mdx'
installation: '@coengageui/modals'
license: MIT
---

import { ModalsDemos } from '@coengageui/demos';
...
```sh
npm install @coengageui/modals @coengageui/core @coengageui/hooks
```

Install with yarn:

```sh
yarn add @coengageui/modals @coengageui/core @coengageui/hooks
```
...
import { ModalsProvider } from '@coengageui/modals';
...
@coengageui/modals package includes special modal that can be used for confirmations.
...
```tsx
import { ContextModalProps, ModalsProvider } from '@coengageui/modals';
