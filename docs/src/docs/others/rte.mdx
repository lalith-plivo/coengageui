...
import: "import { RichTextEditor } from '@coengageui/rte';"
source: 'coengageui-rte/src'
docs: 'others/rte.mdx'
installation: '@coengageui/rte'
license: MIT
...
Package has peer dependencies: [react](https://www.npmjs.com/package/react), [react-dom](https://www.npmjs.com/package/react-dom), [@coengageui/hooks](https://www.npmjs.com/package/@coengageui/hooks) and [@coengageui/core](https://www.npmjs.com/package/@coengageui/core):.

Install with npm:

```sh
npm install @coengageui/rte @coengageui/core @coengageui/hooks
```

Install with yarn:

```sh
yarn add @coengageui/rte @coengageui/core @coengageui/hooks
```
...
import { RichTextEditor, Editor } from '@coengageui/rte';
...
export default dynamic(() => import('@coengageui/rte'), {
