...
import: "import { useQueue } from '@coengageui/hooks';"
docs: 'hooks/use-queue.mdx'
source: 'coengageui-hooks/src/use-queue/use-queue.ts'
---

import { NotificationsDemos } from '@coengageui/demos';

## Usage

use-queue limits the amount of data in current state and place the rest of it in a queue.
For example, in [@coengageui/notifications](/others/notifications/) package amount of
...
```tsx
import { useQueue } from '@coengageui/hooks';
