...
import: "import { useId } from 'coengageui_hooks';"
docs: 'hooks/use-id.mdx'
source: 'coengageui-hooks/src/use-id/use-id.ts'
---
...
```tsx
import { useId } from 'coengageui_hooks';
...
// input and label will have random id 'coengageui-fZMoF'
