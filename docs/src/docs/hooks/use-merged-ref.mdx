...
import: "import { useMergedRef } from '@coengageui/hooks';"
docs: 'hooks/use-merged-ref.mdx'
source: 'coengageui-hooks/src/use-merged-ref/use-merged-ref.ts'
---
...
```tsx
import { useRef } from 'react';
import { useClickOutside, mergeRefs } from '@coengageui/hooks';
