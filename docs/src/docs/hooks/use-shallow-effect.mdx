...
import: "import { useShallowEffect } from 'coengageui_hooks';"
docs: 'hooks/use-shallow-effect.mdx'
source: 'coengageui-hooks/src/use-shallow-effect/use-shallow-effect.ts'
---
...
import { useShallowEffect } from 'coengageui_hooks';
