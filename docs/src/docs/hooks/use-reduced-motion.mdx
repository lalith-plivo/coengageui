...
import: "import { useReducedMotion } from 'coengageui_hooks';"
docs: 'hooks/use-reduced-motion.mdx'
source: 'coengageui-hooks/src/use-reduced-motion/use-reduced-motion.ts'
---
...
All CoengageUI components which use animations support it by default:
