...
import: "import { useClickOutside } from '@coengageui/hooks';"
docs: 'hooks/use-click-outside.mdx'
source: 'coengageui-hooks/src/use-click-outside/use-click-outside.ts'
---
...
import { useClickOutside } from '@coengageui/hooks';
import { Portal } from '@coengageui/core';
