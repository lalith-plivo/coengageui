...
import: "import { useFocusTrap } from '@coengageui/hooks';"
docs: 'hooks/use-focus-trap.mdx'
source: 'coengageui-hooks/src/use-focus-trap/use-focus-trap.ts'
---

import { ModalDemos, MenuDemos } from '@coengageui/demos';
...
```tsx
import { useFocusTrap } from '@coengageui/hooks';
...
import { useClickOutside, useFocusTrap, useMergedRef } from '@coengageui/hooks';
...
use-focus-trap is used in some CoengageUI components: [Modal](/core/modal/), [Drawer](/core/drawer/), [Menu](/core/menu/) and others.
