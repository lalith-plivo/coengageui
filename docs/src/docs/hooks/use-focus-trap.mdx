...
import: "import { useFocusTrap } from 'coengageui_hooks';"
docs: 'hooks/use-focus-trap.mdx'
source: 'coengageui-hooks/src/use-focus-trap/use-focus-trap.ts'
---

import { ModalDemos, MenuDemos } from 'coengageui_demos';
...
```tsx
import { useFocusTrap } from 'coengageui_hooks';
...
import { useClickOutside, useFocusTrap, useMergedRef } from 'coengageui_hooks';
