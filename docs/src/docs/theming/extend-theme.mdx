...
```tsx
import { Button, Code, CoengageUIProvider, Title } from '@coengageui/core';
...
```tsx
import { CoengageUIProvider, Box } from '@coengageui/core';
...
```ts
import { Tuple } from '@coengageui/core';

type CustomColors = 'primaryColorName' | 'secondaryColorName';

declare module '@coengageui/core' {
...
import { Tuple, DefaultCoengageUIColor } from '@coengageui/core';
