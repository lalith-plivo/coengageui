...
import { MediaQueryDemos, CreateStylesDemos } from '@coengageui/demos';

# Responsive styles

`@coengageui/core` package exports several components that can help you organize responsive styles without writing CSS.
