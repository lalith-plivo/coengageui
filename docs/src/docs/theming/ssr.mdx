...
1. Install `coengageui_ssr` package

```bash
yarn add coengageui_ssr

npm install coengageui_ssr
```

2. Create `App` component with `CoengageUIProvider`
...
export function App() {
  return (
    {/* Setup CoengageUIProvider with your theme */}
