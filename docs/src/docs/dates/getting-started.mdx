...
- [@coengageui/hooks](https://www.npmjs.com/package/@coengageui/hooks)
- [@coengageui/core](https://www.npmjs.com/package/@coengageui/core)

Install with npm:

```sh
npm install dayjs @coengageui/core @coengageui/hooks @coengageui/dates
```

Install with yarn:

```sh
yarn add dayjs @coengageui/core @coengageui/hooks @coengageui/dates
```

## Localization

CoengageUI dates uses [dayjs](https://day.js.org/) library for localization.
...
[CoengageUIProvider](/theming/coengageui-provider/) allows you to set a `datesLocale` property for all date components, or you can overwrite the locale on a per component basis:

```tsx
import { DatePicker, Calendar, Month } from '@coengageui/dates';
...
Apart from components @coengageui/dates package also exports several utility functions.
...
```tsx
import { getMonthDays } from '@coengageui/dates';
...
```tsx
import { getMonthsNames } from '@coengageui/dates';
...
```tsx
import { getWeekdaysNames } from '@coengageui/dates';
...
```tsx
import { getYearsRange } from '@coengageui/dates';
...
```tsx
import { isSameDate } from '@coengageui/dates';
...
```tsx
import { isSameMonth } from '@coengageui/dates';
