...
import: "import { DatePicker, DateRangePicker } from '@coengageui/dates';"
source: 'coengageui-dates/src/components/DatePicker/DatePicker.tsx'
docs: 'dates/DatePicker.mdx'
styles: ['DatePicker', 'DateRangePicker']
---

import { DatePickerDemos, DateRangePickerDemos } from '@coengageui/demos';
