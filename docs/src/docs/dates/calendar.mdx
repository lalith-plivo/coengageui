...
import: "import { Calendar, RangeCalendar } from 'coengageui_dates';"
source: 'coengageui-dates/src/components/Calendar/Calendar.tsx'
docs: 'dates/Calendar.mdx'
styles: ['Calendar', 'RangeCalendar']
---

import { CalendarDemos, RangeCalendarDemos } from 'coengageui_demos';
