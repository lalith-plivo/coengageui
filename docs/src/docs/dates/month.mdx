...
props: ['Month']
import: "import { Month } from 'coengageui_dates';"
source: 'coengageui-dates/src/components/Month/Month.tsx'
docs: 'dates/Month.mdx'
styles: ['Month']
---

import { MonthDemos } from 'coengageui_demos';

## Usage

Month is the most basic coengageui_dates component, it displays single month without any controls to change current month.
Component is used as base for [Calendar](/dates/calendar/), [DatePicker](/dates/date-picker/)
and other components. You can use Month to build custom date or date range pickers that are not included in coengageui_dates
...
All coengageui_dates components are built with [dayjs](https://day.js.org/) library.
