...
props: ['Month']
import: "import { Month } from '@coengageui/dates';"
source: 'coengageui-dates/src/components/Month/Month.tsx'
docs: 'dates/Month.mdx'
styles: ['Month']
---

import { MonthDemos } from '@coengageui/demos';

## Usage

Month is the most basic @coengageui/dates component, it displays single month without any controls to change current month.
Component is used as base for [Calendar](/dates/calendar/), [DatePicker](/dates/date-picker/)
and other components. You can use Month to build custom date or date range pickers that are not included in @coengageui/dates
...
All @coengageui/dates components are built with [dayjs](https://day.js.org/) library.
