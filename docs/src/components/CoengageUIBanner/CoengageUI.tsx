...
import { Title, Overlay, Text, Button, Group } from '@coengageui/core';
    ...
    <div className={cx(classes.root, className)} {...others}>
      ...
      <div className={classes.content}>
        ...
        <Text size="sm" sx={{ lineHeight: 1.7 }}>
          ...
          components support dark/light color scheme and CoengageUI theme customizations. CoengageUI UI is
          free for everyone.
        </Text>
        <Group mt="xl">
